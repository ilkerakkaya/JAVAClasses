...
public class Nestededif01 {

	public static void main(String[] args) {
		/*
		 ask user to enter age and gender
		 if the gender is male and age is less than 20 print boy otherwise print man 
		 if the gender is female  and age is less than 20 print girl otherwise print woman on the console.
