...
public class MethodCreation03 {
	...
	/*
	 ...
	 Method Overloading: if u create methods whose names are same but parameters are different it means u r method overloading. 
	 
	 is method overloading Compile time or run time polymorphism?
	 answer is compile time polymorphism
	 */
